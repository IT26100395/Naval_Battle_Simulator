...
void runSimulation3()
{
    ...
    struct EnemyShip ships[MAX_SHIPS] =
    {
        ...
        {1,"EA",20,30,0.08,20,3},

        {2,"EB",60,40,0.06,30,5},

        {3,"EC",80,70,0.07,25,4},

        {4,"ED",30,80,0.05,50,6},

        {5,"EE",90,20,0.04,70,2}
    ...
    file = fopen("simulation3_result.txt","a");
    ...
    for(int i=0;i<MAX_SHIPS;i++)
    {
        ...
        if(distance <= ships[i].angleRange)
        {
